    ...
    <main style={{
      ...
      backgroundColor: '#f8f9fa',
        ...
        <div style={{
          ...
          {babies.map((baby) => (
            <div key={baby.id} style={{ position: 'relative', flex: 'shrink' }}>
              {editingBabyId === baby.id ? (
                ...
                <div
                  onMouseEnter={(e) => {
                    const icon = e.currentTarget.querySelector('[data-edit-icon]') as HTMLElement
                ...
                >
                  <button
                    ...
                    style={{
                      padding: '1rem 1.5rem',
                      backgroundColor: selectedBabyId === baby.id ? '#fff' : '#f5f5f5',
                      color: selectedBabyId === baby.id ? '#4a90e2' : '#666',
                      border: 'none',
                      borderBottom: selectedBabyId === baby.id ? '3px solid #4a90e2' : '3px solid transparent',
                      cursor: 'pointer',
                      fontSize: '0.95rem',
        ...
        <div style={{
          ...
          {feeds.length === 0 ? (
            <p style={{ textAlign: 'center', color: '#999', marginTop: '2rem', fontSize: '1.1rem' }}>
                  ...
                  <div style={{ 
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                      ...
                      <div>
                        ...
                        {feed.feedType.name === 'Milk' && typeof feed.amountMl === 'number' && (
                          <div style={{ 
                            fontSize: '1rem', 
                            color: '#4a90e2',
                            marginTop: '0.15rem',
            ...
            <div style={{
              ...
              <div style={{
                ...
                <button
                  ...
                  onMouseDown={(e) => {
                    if (!loading) {
                      e.currentTarget.style.transform = 'scale(0.95)'
                      e.currentTarget.style.boxShadow = '0 1px 4px rgba(74,144,226,0.3)'
                    }
                  }}
                  onMouseUp={(e) => {
                    e.currentTarget.style.transform = 'scale(1)'
                ...
                >
                  ...
                  <span>Log Milk</span>
                  <span style={{ fontSize: '1rem', opacity: 0.9 }}>({milkAmount}ml)</span>
                </button>
                <button
                  ...
                  onMouseDown={(e) => {
                    if (!loading) {
                      e.currentTarget.style.transform = 'scale(0.95)'
                      e.currentTarget.style.boxShadow = '0 1px 4px rgba(40,167,69,0.3)'
                    }
                  }}
                  onMouseUp={(e) => {
                    e.currentTarget.style.transform = 'scale(1)'
              ...
              <button
                ...
                onMouseDown={(e) => {
                  if (!loading) {
                    e.currentTarget.style.transform = 'scale(0.95)'
                    e.currentTarget.style.boxShadow = '0 1px 4px rgba(243,156,18,0.3)'
                  }
                }}
                onMouseUp={(e) => {
                  e.currentTarget.style.transform = 'scale(1)'
